    ...
    return (
        <div className="flex flex-col gap-y-12 md:gap-y-15 mt-10 md:mt-20 px-6 md:px-0">
            ...
            <div className="flex flex-col gap-y-6 md:gap-y-8 justify-center items-center">
                <p className="px-3 heroText py-1 rounded-2xl w-fit bg-secondary/20 text-secondary font-normal text-sm md:text-lg text-center">
                    Introducing Scotch
                </p>

                {/* Heading: text-4xl on mobile, text-6xl on desktop */}
                <h1 className="text-4xl heroText md:text-6xl font-medium w-full md:max-w-[70%] lg:max-w-[55%] text-center text-primary leading-tight">
                    The system that knows liquor like you do.
                </h1>

                {/* Subtext: text-base on mobile, text-xl on desktop */}
                <p className="text-base heroText md:text-xl font-normal w-full md:max-w-[60%] lg:max-w-[40%] text-center text-primary">
                    Far from just another POS, Scotch is the all-in-one operating system designed exclusively for liquor retailers.
                </p>

                <div className="flex flex-col heroText sm:flex-row gap-4 sm:gap-x-3 w-full sm:w-auto items-center">
            ...
            <div id="heroimg" className="flex justify-center items-center overflow-hidden">
                <img
